...
MAKEFILE = stat_lpks_wob_mex.mk

include stat_lpks_wob_mex.mki
...
SYS_INCLUDE += /I "$(START_DIR)\codegen\mex\stat_lpks_wob"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\stat_lpks_wob/%.c
	$(CC) $(CFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\stat_lpks_wob/%.cpp
	$(CC) $(CPPFLAGS) "$<"
