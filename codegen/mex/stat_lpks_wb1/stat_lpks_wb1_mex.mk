...
MAKEFILE = stat_lpks_wb1_mex.mk

include stat_lpks_wb1_mex.mki
...
SYS_INCLUDE += /I "$(START_DIR)\codegen\mex\stat_lpks_wb1"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\stat_lpks_wb1/%.c
	$(CC) $(CFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\stat_lpks_wb1/%.cpp
	$(CC) $(CPPFLAGS) "$<"
