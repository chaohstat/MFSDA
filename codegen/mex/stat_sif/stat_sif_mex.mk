START_DIR = C:\Users\ADMINI~1\Desktop\SALT_S~1

MATLAB_ROOT = C:\PROGRA~1\MATLAB\R2016b
MAKEFILE = stat_sif_mex.mk

include stat_sif_mex.mki
...
SRC_FILES =  \
	...
	sum.c \
	squeeze.c \
	_coder_stat_sif_info.c \
	_coder_stat_sif_api.c \
	_coder_stat_sif_mex.c \
	stat_sif_emxutil.c

MEX_FILE_NAME_WO_EXT = stat_sif_mex
...
SYS_INCLUDE += /I "$(START_DIR)\codegen\mex\stat_sif"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\stat_sif/%.c
	$(CC) $(CFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\stat_sif/%.cpp
	$(CC) $(CPPFLAGS) "$<"
